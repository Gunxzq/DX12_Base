...
//     mhMainWnd = CreateWindow(L"MainWnd", mMainWndCaption.c_str(), WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT,
...
// ID3D12Resource *D3DApp::CurrentBackBuffer() const { return mSwapChainBuffer[mCurrBackBuffer].Get(); }
...
// D3D12_CPU_DESCRIPTOR_HANDLE D3DApp::DepthStencilView() const { return mDsvHeap->GetCPUDescriptorHandleForHeapStart();
// }
