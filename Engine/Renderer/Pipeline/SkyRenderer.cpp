...
void SkyRenderer::LoadShaders() {
    ...
    hr = CompileShaderFromFile(L"Shaders/Sky.hlsl", "VS", "vs_5_1", compileFlags, m_vsBlob, &errors);
    ...
    errors = nullptr;
    hr = CompileShaderFromFile(L"Shaders/Sky.hlsl", "PS", "ps_5_1", compileFlags, m_psBlob, &errors);
