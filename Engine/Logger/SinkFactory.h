...
private:
    ...
    static std::shared_ptr<spdlog::sinks::sink> CreateConsoleSink(const LogConfig &config);
    static std::shared_ptr<spdlog::sinks::sink> CreateFileSink(const LogConfig &config);
    static std::shared_ptr<spdlog::sinks::sink> CreateDebugOutputSink(const LogConfig &config);
    static std::shared_ptr<spdlog::sinks::sink> CreateLogWindowSink(const LogConfig &config);
};
